...
const AllTask = () => {
    ...
    return (
        <div className='bg-[#1e1e1e] rounded-xl shadow-md shadow-black/10 p-6 mt-6'>
            ...
            <div className='bg-green-800 mb-4 py-3 px-6 flex justify-between rounded-lg'>
            ...
            <div className='overflow-auto max-h-[300px]'>
                {userData.map((element) => (
                    <div
                        key={element.id}
                        className='bg-[#1e1e1e] border border-green-800 hover:bg-[#222222] mb-2 py-3 px-6 flex justify-between rounded-lg transition-all duration-200'>
