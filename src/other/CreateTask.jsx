...
const CreateTask = () => {
  ...
  return (
    <div className='bg-[#1e1e1e]  p-6 rounded-xl shadow-md shadow-black/10 mt-6'>
      <h2 className='text-xl font-bold border-green-700 mb-6'>Create New Task</h2>
      <form onSubmit={submitHandler} className='flex flex-wrap w-full items-start justify-between'>
        <div className='w-1/2 '>
          <div className='mb-4'>
            <label className='block text-sm font-medium border-green-700 mb-1'>Task Title</label>
            <input
              name="taskTitle"
              value={formData.taskTitle}
              onChange={handleInputChange}
              className='w-4/5 px-4 py-2 rounded-lg border border-green-700 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition-all'
              type="text"
          ...
          <div className='mb-4'>
            <label className='block text-sm font-medium border-green-700 mb-1'>Date</label>
            <input
              name="taskDate"
          ...
          <div className='mb-4'>
            <label className='block text-sm font-medium border-green-700 mb-1'>Assign To</label>
            <input
              name="assignTo"
        ...
        <div className='w-2/5'>
          ...
          <button 
            type="submit"
            className='w-full mt-4 bg-emerald-800  hover:bg-emerald-600 text-white font-semibold py-3 rounded-lg transition-all duration-200'
          >
            Create Task
          </button>
        </div>
